 ...
 * https://bugs.eclipse.org/bugs/show_bug.cgi?id=343156 <br/>
 * This is required when running Plug-in tests in Tycho that requires the PDE,
 * for example, for testing that the imported projects compile fine, or if they
 * use the DSL, which requires PDE projects dependencies.
 * 
...
public class PDETargetPlatformUtils {
	...
	/**
	 * Sets a target platform in the test platform to get workspace builds OK with
	 * PDE.
	 * 
	 * @throws Exception
	 */
